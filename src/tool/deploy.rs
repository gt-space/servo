use crate::tool::task::{task, subtask, pass, fail};
...
pub fn fetch_toolchain(toolchain: &'static str) {
...
pub async fn deploy() -> anyhow::Result<()> {
	...
	let hosts = [
		...
		Host::find("localhost", HostType::ControlServer, "jeffreyshelton", "2016Jackets!"),
